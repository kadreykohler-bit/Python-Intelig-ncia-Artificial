# Recebe a entrada do usuário como uma string e divide essa string nos
# caracteres ',' (vírgula),
temperaturas_celsius = input().split(',')

# função chamada converter_celsius_para_fahrenheit que recebe uma lista de
# strings
...
# TODO: Calcule as temperaturas em Fahrenheit para cada temperatura em
    # Celsius convertida para float
